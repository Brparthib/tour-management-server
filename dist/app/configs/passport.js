...
passport_1.default.use(new passport_local_1.Strategy({
    ...
    try {
        ...
        if (isUserExist.isActive === user_interface_1.IsActive.BLOCKED ||
            ...
            return done(`User is ${isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist.isActive}`);
        }
        if (isUserExist.isDeleted) {
            return done("User is deleted!!");
        }
        const isGoogleAuthenticated = isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist.auths.some((providerObj) => providerObj.provider === "google");
        if (isGoogleAuthenticated && !(isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist.password)) {
            return done(null, false, {
                message: "You have authenticated through google. Please login with google and set a password.",
            });
        }
        const validPassword = yield bcryptjs_1.default.compare(password, isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist.password);
        if (!validPassword) {
