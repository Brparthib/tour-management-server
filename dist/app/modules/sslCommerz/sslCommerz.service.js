...
const sslPaymentInit = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = {
            ...
            fail_url: `${env_1.envVars.SSL.SSL_FAIL_BACKEND_URL}?transactionId=${payload.transactionId}&amount=${payload.amount}&status=failed`,
...
const validatePayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, `Payment Validation Error: ${error.message}`);
    }
});
exports.sslService = {
    sslPaymentInit,
